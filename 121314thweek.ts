...
//Array:a data structure that stores collection of elements it can contain elemets(no,string,object ,datatype)using []
...
//empty array
let Names1 = ['Alveena', 'Aftab','Hania'];
Names1.pop()
Names1.pop()
Names1.pop()
console.log(Names1);  //print remove all elememt
...
let Names2 = ['alveena','furqan']
Names2.push("aftab")     //in pop we dont write anything in () but in push we will write element that we have to add alsi
//add "" and console
console.log(Names2);
//print aftab in starting

// 3) UNSHIFT :it also add element but it add always at first position
let Names3 = ['aniqa','tanzeel']
Names3.unshift('faiqa');
console.log(Names3);

// 4) SHIFT :oposite to unshift it will remove first element
 let Names4 = ['aniqa','tanzeel']
 console.log(Names4.shift()); //here we dont have to write any thing b/c it will remove
 console.log(Names4); //like in pop it remove from last it will remove from start
...
let Names22 = ['amara','waseema']
console.log(Names22.slice().reverse())
...
let Names23 = ['saiqa','hania','muneeza','rubaisha']
Names23.splice(1,1) 
//here now i want to remove hania i will add position no as position no starts from 0 and nowi will add
//,an will tell the no till where i want to remove elements.so here i just want to remove hania so i will add 1,1//console.
//log(Names);print : saiqa,muneeza,rubaisha now if i want also muneeza o remove so i will write 1, to its posiion no
let Names21 = ['saiqa','hania','muneeza','rubaisha']
Names21.splice(1,2)
console.log(Names21); //print:saiqa,rubaisha
...
//1St method here i want to add sajida in saiqa place we will write indexing position of saiqa that is 1, and again postion 
// where you want to add new element ali so 1,1,"ali"
let Names12 = ['saiqa','hania']
Names12.splice(1,0,"ali") //here if i write 0 it will indicate that no element should remove like if we write 1,0,ali
console.log(Names12);
...
let Names45 = ['Alveena','Aniqa','Areeba','Saiqa']
console.log(Names45.length); //print 4
...
let Names34: "yellow" = "yellow" ; //example of type literals and here if i write blue in value ir will give error
