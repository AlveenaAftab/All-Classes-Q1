...
//Data types: string(for textual data),numbers(intergers and floating_point numbers,numerical values),boolean(true,false)
...
userInput = 5;
userInput = "Hellow"; ///don;t know data type

//BigInt
let bigNumber :bigint = 100000000n;
...
//null
let results:null = null ;//intentionally empty

//primitive types :number,string ,boolean,void,null,undefined,never
//user-defined types :array,class,interface,tuple,enum,function 


//4)Comments in code: use for programme clarification ,green in color or other may be. easy for understanding,compiler
//do not read it.
...
lett b : number = 10:  //or //lett bhi syntax error
...
//type annotation :providetypes

//hoisting means use variable before assigned,occur in var, not occur in let.

//block scope is let

//fonction scope is var
