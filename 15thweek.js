...
//number method
// let a = 23; //now remember when using array method we always write array name then . then arraymethod list show similarly here
// //we will write datatype name then . then its method name like
// console.log(a.toFixed(2)) ;          //tofixed will add number to your given num like we have writ 55 if in () i write 2 it will print 
...
// console.log(myname[0].toUpperCase()+ myname.slice(1).toLowerCase())// error comes b/c in first it will convert to uppercase just to
//N as it is in 1 indexing position so it will print Naniqa 
//.lowercase means it will also convert to lowercase like first 0 no will be uppercase then slice will cpy all other material
